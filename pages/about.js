  ...
  return (
    <>
      ...
      <main>
        <div class="contact">
          <h3>Contact</h3>        
          <Image src={mailIcon} class="mailicon" alt="Picture of the author" width={40} placeholder="empty" /><a href="mailto:sebastian.heckmann@outlook.com">sebastian.heckmann@outlook.com</a>
        </div>
        <div class="links">
          <h3>More</h3>
